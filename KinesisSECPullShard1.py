##
##
## C:/EdsScripts/KinesisSECPullShard1.py
##
## Pull multiple stock trade records from Kinesis (Shard 1) in JSON format and unwrap them
##
##  2017-05-25  Clean up output print statements
##  2017-05-16  Add nShardIdNdx and nSleepTime, nTotalPulled, delete debug print statements
##
